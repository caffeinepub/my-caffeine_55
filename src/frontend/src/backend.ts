...
export class Backend implements backendInterface {
    ...
    async getChatStats(): Promise<[bigint, bigint, bigint]> {
        if (this.processError) {
            try {
                const result = await this.actor.getChatStats();
                return [
                    result[0],
                    result[1],
                    result[2]
    ...
    async getPrivateMessages(): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrivateMessages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchFaqsByKeyword(arg0: string): Promise<Array<FaqEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchFaqsByKeyword(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FaqEntry]): FaqEntry | null {
